...
const mappingColors = [
	...
	`TRANSPARENT|border:#border-color:#border-top:#border-bottom:#border-left:#border-right:#borderColor:|transparent`,
	`TRANSPARENT|background:#background-color:#backgroundColor:#bgColor:#bgShade:#bg_color:#fill:|transparent`,
	`TRANSPARENT|color:#color =|transparent`,
	`TROPICAL_BLUE|background:#background-color:#backgroundColor:#bgColor:#bgShade:#bg_color:#fill:|bgTokens.COLOR_BG_SELECTED`,
