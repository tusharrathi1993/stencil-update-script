...
const mappingColors = [
	...
	`INDIGO|background:#background-color:#backgroundColor:#bgColor:#bgShade:#bg_color:#fill:|moduleTokens.COLOR_MODULE_HUB`,
	`INDIGO|background:#background-color:#backgroundColor:#bgColor:#bgShade:#bg_color:#fill:|moduleTokens.COLOR_MODULE_SERIES`,
